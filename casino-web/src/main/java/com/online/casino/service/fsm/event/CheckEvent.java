 ...
 */
public final class CheckEvent extends AbstractGamblerEvent {
     ...
     */
    public CheckEvent(String pokergameId, String handId, String applicationUserId, String gamblerId) {
