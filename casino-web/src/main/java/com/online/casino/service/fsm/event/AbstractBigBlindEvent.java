 ...
 */
public abstract class AbstractBigBlindEvent extends AbstractGamblerEvent {
     ...
     */
    public AbstractBigBlindEvent(String pokergameId, String handId, String applicationUserId, String gamblerId) {
