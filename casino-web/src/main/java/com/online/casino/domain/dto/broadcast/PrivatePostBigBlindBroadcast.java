 ...
 * Responsibility:
 */
public final class PrivatePostBigBlindBroadcast implements GameBroadcast, HandBroadcast, UserBroadcast {
     ...
     */
    public PrivatePostBigBlindBroadcast(String pokergameId, String handId, String applicationUserId) {
