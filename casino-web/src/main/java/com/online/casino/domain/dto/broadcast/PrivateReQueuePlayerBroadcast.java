 ...
 * Responsibility:
 */
public final class PrivateReQueuePlayerBroadcast implements GameBroadcast, UserBroadcast {
     ...
     */
    public PrivateReQueuePlayerBroadcast(String pokergameId, String applicationUserId) {
