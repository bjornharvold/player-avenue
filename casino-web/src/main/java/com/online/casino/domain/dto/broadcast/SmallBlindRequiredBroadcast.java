 ...
 * Responsibility:
 */
public final class SmallBlindRequiredBroadcast implements GameBroadcast, HandBroadcast {
     ...
     */
    public SmallBlindRequiredBroadcast(String pokergameId, String handId, String nickname) {
