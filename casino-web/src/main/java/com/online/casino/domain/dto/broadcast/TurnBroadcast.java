 ...
 * Date: 2/2/11
 * Time: 2:25 PM
 * Responsibility: Contains all the data necessary to broadcast turn data
 */
public final class TurnBroadcast implements GameBroadcast, HandBroadcast {
     ...
     * @param card4 card4
     */
    public TurnBroadcast(String pokergameId, String handId, String card1, String card2, String card3, String card4) {
