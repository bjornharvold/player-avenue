 ...
 * Responsibility:
 */
public final class PlayerResponseRequiredBroadcast implements GameBroadcast, HandBroadcast {
     ...
     */
    public PlayerResponseRequiredBroadcast(String pokergameId, String handId, String nickname) {
