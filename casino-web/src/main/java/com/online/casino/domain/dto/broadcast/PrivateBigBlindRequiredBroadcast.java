 ...
 * from him.
 */
public final class PrivateBigBlindRequiredBroadcast implements GameBroadcast, HandBroadcast, UserBroadcast {
     ...
     * @param amount              amount
     */
    public PrivateBigBlindRequiredBroadcast(String pokergameId, String handId, String applicationUserId, Integer time,
            BigDecimal amount) {
