 ...
 * Responsibility:
 */
public class ReQueuePlayerBroadcast implements GameBroadcast, UserBroadcast {

    /** Field description */
    private final GameEvent event = GameEvent.REQUEUE_PLAYER_EVENT;
     ...
     */
    public ReQueuePlayerBroadcast(String pokergameId, String applicationUserId, String playerId, BigDecimal buyin,
