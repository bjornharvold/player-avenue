 ...
 * Responsibility:
 */
public final class RaiseBroadcast implements GameBroadcast, HandBroadcast {

    /** Field description */
    private final GameEvent event = GameEvent.RAISE_EVENT;
     ...
     */
    public RaiseBroadcast(String pokergameId, String handId, String playerNickname, BigDecimal amount, BigDecimal pot,
