 ...
 * Responsibility:
 */
public final class PrivateFoldBroadcast implements GameBroadcast, HandBroadcast, UserBroadcast {
    ...
    public PrivateFoldBroadcast(String pokergameId, String handId, String applicationUserId) {
