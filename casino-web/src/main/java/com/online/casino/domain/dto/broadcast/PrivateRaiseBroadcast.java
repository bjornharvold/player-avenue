 ...
 * Responsibility:
 */
public final class PrivateRaiseBroadcast implements GameBroadcast, HandBroadcast, UserBroadcast {
     ...
     */
    public PrivateRaiseBroadcast(String pokergameId, String handId, String applicationUserId) {
