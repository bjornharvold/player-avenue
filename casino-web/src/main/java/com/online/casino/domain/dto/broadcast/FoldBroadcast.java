 ...
 * Responsibility:
 */
public final class FoldBroadcast implements GameBroadcast, HandBroadcast {

    /** Field description */
    private final GameEvent event = GameEvent.FOLD_EVENT;
     ...
     */
    public FoldBroadcast(String pokergameId, String handId, String playerNickname, BigDecimal amount, BigDecimal pot,
