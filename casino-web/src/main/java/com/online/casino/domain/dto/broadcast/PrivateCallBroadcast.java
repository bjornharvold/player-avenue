 ...
 * Responsibility:
 */
public final class PrivateCallBroadcast implements GameBroadcast, HandBroadcast, UserBroadcast {
     ...
     */
    public PrivateCallBroadcast(String pokergameId, String handId, String applicationUserId) {
