 ...
 * Responsibility:
 */
public final class PrivateTimeoutBroadcast implements GameBroadcast, HandBroadcast, UserBroadcast {
     ...
     */
    public PrivateTimeoutBroadcast(String pokergameId, String handId, String applicationUserId) {
