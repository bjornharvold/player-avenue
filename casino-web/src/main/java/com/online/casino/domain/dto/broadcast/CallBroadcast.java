 ...
 * Responsibility:
 */
public final class CallBroadcast implements GameBroadcast, HandBroadcast {

    /** Field description */
    private final GameEvent event = GameEvent.CALL_EVENT;
     ...
     */
    public CallBroadcast(String pokergameId, String handId, String playerNickname, BigDecimal amount, BigDecimal pot,
