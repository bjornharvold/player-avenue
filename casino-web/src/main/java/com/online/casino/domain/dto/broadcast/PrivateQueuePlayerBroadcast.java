 ...
 * Responsibility:
 */
public final class PrivateQueuePlayerBroadcast implements GameBroadcast, UserBroadcast {
     ...
     */
    public PrivateQueuePlayerBroadcast(String pokergameId, String applicationUserId) {
