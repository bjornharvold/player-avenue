...
public class Deck {
    ...
    public Deck(String deck) {
        // this will convert a string, as generated by the toString function on this class, back to a deck object
        StringTokenizer st = new StringTokenizer(deck, "|", false);

        // the first part of the string should be the used ones
        if (st.countTokens() == 1) {
            // this means the deck is new and no cards have been dealt yet
            position = 0;
            ...
            while (st2.hasMoreTokens()) {
                gCards[i] = new Card(st2.nextToken());
                i++;
            }
        } else if (st.countTokens() == 2) {
            // the first token will be used cards and the second token will be unused cards
            StringTokenizer st2 = new StringTokenizer(st.nextToken(), " ", false);
     ...
     */
    public synchronized void extractHand(SingleHand h) {
