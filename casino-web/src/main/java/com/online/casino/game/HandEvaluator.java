...
public class HandEvaluator {
    ...
    public static void main(String args[]) {
        ...
        SingleHand riverHigh = new SingleHand("Ah Kh Qh Jh Th 2c 3c");
        SingleHand riverLow = new SingleHand("9h 5h 4s 8h 7c 3c 2h");
        SingleHand pocketHigh = new SingleHand("Ah Ac");
        SingleHand pocketLow = new SingleHand("2c 3h");
        SingleHand flopHigh = new SingleHand("Ah Ac As Ad 2h"); //2599207
        SingleHand flopLow = new SingleHand("2c 3h 4s 5c 7h");
        SingleHand turnHigh = new SingleHand("Ah Ac As Ad 2h");
        SingleHand turnLow = new SingleHand("2c 3h 4s 5c 7h 8h");
        SingleHand test = new SingleHand("8c 7h");

        /*
        SingleHand hand1 = new SingleHand("Kc 8c 9c Tc Jc Qc Ac");
        SingleHand hand2 = new SingleHand("Kc 8c 9c Tc Jc Qc Ad");
        ...
        System.out.println("Comparing hands: " + handEval.compareHands(hand2, hand1));
        */

        System.out.println("River High");
        System.out.println(HandEvaluator.rankHand(riverHigh));
        System.out.println(HandEvaluator.nameHand(riverHigh));

        System.out.println("River Low");
        System.out.println(HandEvaluator.rankHand(riverLow));
        System.out.println(HandEvaluator.nameHand(riverLow));

        System.out.println("Turn High");
        System.out.println(HandEvaluator.rankHand(turnHigh));
        System.out.println(HandEvaluator.nameHand(turnHigh));

        System.out.println("Turn Low");
        System.out.println(HandEvaluator.rankHand(turnLow));
        System.out.println(HandEvaluator.nameHand(turnLow));

        System.out.println("Flop High");
        System.out.println(HandEvaluator.rankHand(flopHigh));
        System.out.println(HandEvaluator.nameHand(flopHigh));

        System.out.println("Flop Low");
        System.out.println(HandEvaluator.rankHand(flopLow));
        System.out.println(HandEvaluator.nameHand(flopLow));

        System.out.println("Pocket High");
        System.out.println(HandEvaluator.rankHand(pocketHigh));
        System.out.println(HandEvaluator.nameHand(pocketHigh));

        System.out.println("Pocket Low");
        System.out.println(HandEvaluator.rankHand(pocketLow));
        System.out.println(HandEvaluator.nameHand(pocketLow));

        System.out.println("Test");
        System.out.println(HandEvaluator.rankHand(test));
        System.out.println(HandEvaluator.nameHand(test));
    }
     ...
     */
    public int rankHand(Card c1, Card c2, SingleHand h) {
        h.addCard(c1);
        h.addCard(c2);
        int rank = rankHand(h);
        h.removeCard();
     ...
     */
    public static String nameHand(SingleHand h) {
     ...
     */
    public int compareHands(SingleHand h1, SingleHand h2) {
        int r1 = rankHand(h1);
        int r2 = rankHand(h2);
     ...
     * @return 1 = first hand is best, 2 = second hand is best, 0 = tie
     */
    public int compareHands(int rank1, SingleHand h2) {
        int r1 = rank1;
        int r2 = rankHand(h2);
     ...
     */
    public int[][] getRanks(SingleHand board) {
        SingleHand myhand = new SingleHand(board);
     ...
     *         input.
     */
    public SingleHand getBest5CardHand(SingleHand h) {
        int[] ch = h.getCardArray();
        int[] bh = new int[6];
        int j = Find_Hand(ch, bh);
        SingleHand nh = new SingleHand();
        for (int i = 0; i < 5; i++)
            nh.addCard(bh[i + 1]);
        return nh;
    }
    ...
    private final static byte ID_ExistsStraightFlush(SingleHand h, byte major_suit) {
    ...
    private final static int ID_KickerValueSuited(SingleHand h, int kickers, byte suit) {
        int i;
        int value = 0;
        ...
        for (i = 0; i < h.size(); i++) {
            Card card = h.getCard(i + 1);
            if (card.getSuit() == suit) {
                present[card.getRank()] = true;
            } else {
                present[card.getRank()] = false;
            }
        }
     ...
     *         the hand is.
     */
    public final static int rankHand(SingleHand h) {
        ...
        } else if (group_size[2] >= 2) {    // FIND_A_GAME PAIR
