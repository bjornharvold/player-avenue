 ...
 * Responsibility:
 */
public class THNLCallsOnly3PlayersFunctionalTest extends AbstractPokerGameFunctionalTest {
    private final static Logger log = LoggerFactory.getLogger(THNLCallsOnly3PlayersFunctionalTest.class);

    @Test
    public void testCallsOnly() {
        try {
    ...
    private void handleShowdown(Hand hand) throws GameException {
        ...
        assertEquals("Pot amount is not as expected", new BigDecimal(30.00).floatValue(), potAmount.floatValue(), 0);
        ...
        for (Gambler winner : winners) {
            ...
            assertTrue("Winner didn't win anything", win.compareTo(new BigDecimal(30.00)) == 0);
        }
        ...
        for (Gambler loser : losers) {
            ...
            assertTrue("Winner didn't win anything", loss.compareTo(new BigDecimal(10.00)) == 0);
        }
